...
function AutoScroller(elements) {
    ...
    var pointCB = index$3(point, {
        allowUpdate: function allowUpdate(event) {
    ...
    this.sync = boolean(options.sync, false);
    ...
    function autoScroll(el) {
        ...
        //console.log('el.pageX ',el.pageX)
        //console.log('el.pageX + scrollx ',el.pageX + scrollx)
        //console.log('el.clientX ',el.clientX)
