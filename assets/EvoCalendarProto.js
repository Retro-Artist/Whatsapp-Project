...
EvoCalendar.prototype.buildTheBones = function () {
    ...
    if (!_.$elements.calendarEl.html()) {
        ...
        // sidebar
        markup = '<div class="calendar-sidebar" style="box-sizing: border-box;">' +
        ...
        // inner
        markup += '<div class="calendar-inner" style="box-sizing: border-box;">' +
        ...
        // events
        markup += '<div class="calendar-events" style="box-sizing: border-box;">' +
...
EvoCalendar.prototype.addEventList = function (event_data) {
    ...
    markup = '<div class="event-container" role="button" data-event-index="' + (event_data.id) + '" title="Clique para visualizar">';
    markup += '<div class="event-icon" style="box-sizing: border-box;"><div class="event-bullet-' + event_data.type + '"';
    if (event_data.color) {
